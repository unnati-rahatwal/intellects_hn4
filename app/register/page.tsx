...
import { Accessibility, Mail, Lock, Loader2, ArrowRight, User, Phone, ShieldCheck } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Optional: Auto-login could be implemented here if the register API returned a token
      ...
      <div className="w-full max-w-md relative z-10 transition-all">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 font-medium">
            Start shipping accessible experiences today
          </p>
        </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-5">
              <div className="space-y-2">
                <label htmlFor="name" className="text-sm font-bold text-slate-300 ml-1 flex items-center gap-2">
              ...
              <div className="space-y-2">
                <label htmlFor="number" className="text-sm font-bold text-slate-300 ml-1 flex items-center gap-2">
